    ...
    return (
      ...
      >
        ...
        <Space size="large" style={{'width':'100%'}}>
          <Form.Item label="Hero Image" name="heroImage" style={{'width':'100%', 'padding':'2%'}}>
            <Dragger {...dragger_props}>
            <p className="ant-upload-text" style={{'padding':'5%', 'width':'100%'}}>
                Drop Image here
            </p>
            </Dragger>
          </Form.Item>
          <Form.Item label="Logo Image" name="logoImage" style={{'width':'100%'}}>
            <Dragger {...dragger_props}>
            <p className="ant-upload-text" style={{'padding':'5%', 'width':'100%'}}>
                Drop Image here
            </p>
