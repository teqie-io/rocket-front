...
{
    const [optionVal,setState] =useState({duration:'monthly',impressions:'500'})
    function onChange2(e){
        console.log(e.target.value);
        console.log(optionVal.duration);
        if(e.target.value==="monthly")
        {setState({duration:'monthly',impressions:'500'});}
        else
        {setState({duration:'yearly',impressions:'1000'});}
      };
      const Basic=()=>{
        return(
            <Card 
            ...
            <div>
                ...
                <Row style={{'padding':'5px','background':'#F3FBFF'}}>
                    <Col span={24} align='middle' className="prem-blue-text">{optionVal.impressions}</Col>
